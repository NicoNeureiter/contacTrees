...
import sphericalGeo.ApproxMultivariateTraitLikelihoodF;
 ...
 */
public class ConversionPriorGeo extends Distribution {
	...
	final public Input<ApproxMultivariateTraitLikelihoodF> geoLikelihoodInput = new Input<>(
	        "geoLikelihood",
	        "The geographic likelihood, providing geo-locations at the internal nodes of the tree.",
	        Input.Validate.REQUIRED);
	...
	public double calculateLogP() {
		...
		double[][] nodeLocations = geoLikelihood.getPositions();
