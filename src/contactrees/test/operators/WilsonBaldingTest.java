 ...
 * @author Tim Vaughan
 */
public class WilsonBaldingTest extends contactrees.test.ContactreesTest {
	...
	public class TreeReport extends Logger {
		...
		public Input<Integer> burninInput = new Input<Integer>("burnin",
				"Number of samplesSimulator to skip (burn in)", Input.Validate.REQUIRED);
		...
		ACGWithMetaDataLogger treeToTrack;
		...
		public void initAndValidate() {
			...
			treeToTrack = (ACGWithMetaDataLogger) loggers.get(0);
		...
		public void log(long nSample) {
			...
			traceAnalysis.addTree(treeToTrack.getACG());
		}
